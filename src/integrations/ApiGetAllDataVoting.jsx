...
export class GetResultVotingAPIRequest extends ApiUrlPagination {
    ...
    fetch = async () => {
        ...
        if (response) data = await (new GetResultVotingAPIResponse(response)).getData();
        return { response, data };
    };

}

export class GetResultVotingAPIResponse extends APIResponse {
    validateResponse = () => {
        let error = ErrorMessage;
