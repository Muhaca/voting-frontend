...
export class GetDataKecamatanAPIRequest extends ApiUrlPagination {

    fetch = async () => {
        let url = process.env.REACT_APP_HOST_VOT + '/gettotaldata/get';
        ...
        if (response) data = await (new GetDataKecamatanAPIResponse(response)).getData();
        return { response, data };
    };

}

export class GetDataKecamatanAPIResponse extends APIResponse {
    validateResponse = () => {
        let error = ErrorMessage;
