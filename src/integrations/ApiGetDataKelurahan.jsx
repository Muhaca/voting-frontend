...
export class GetDataKelurahanAPIRequest extends ApiUrlPagination {

    fetch = async () => {
        let url = process.env.REACT_APP_HOST_VOT + '/gettotaldatakel/get';
        ...
        if (response) data = await (new GetDataKelurahanAPIResponse(response)).getData();
        return { response, data };
    };

}

export class GetDataKelurahanAPIResponse extends APIResponse {
    validateResponse = () => {
        let error = ErrorMessage;
